...
//有机灌注器
  ...
  event.recipes.thermal.chiller(Item.of('etshtinker:electronium','tconstruct:gem_cast'), Fluid.of('etshtinker:molten_electronium', 90)).energy(800)
  event.recipes.thermal.chiller(Item.of('etshtinker:trinity_intereactive_alloy','tconstruct:gem_cast'), Fluid.of('etshtinker:molten_trinity_intereactive_alloy', 90)).energy(800)
  event.recipes.thermal.chiller(Item.of('tinkers_reforged:titanium_ingot','tconstruct:gem_cast'), Fluid.of('kubejs:zirconium_fluid', 90)).energy(800)
  ...
  event.recipes.thermal.chiller(Item.of('minecraft:redstone','tconstruct:gem_cast'), Fluid.of('thermal:redstone', 100)).energy(1000)
  event.recipes.thermal.chiller(Item.of('minecraft:diamond','tconstruct:gem_cast'), Fluid.of('tconstruct:molten_diamond', 100)).energy(1000)
  event.recipes.thermal.chiller(Item.of('minecraft:emerald','tconstruct:gem_cast'), Fluid.of('tconstruct:molten_emerald', 100)).energy(1000)
  event.recipes.thermal.chiller(Item.of('minecraft:quartz','tconstruct:gem_cast'), Fluid.of('tconstruct:molten_quartz', 100)).energy(1000)
  //离心机
