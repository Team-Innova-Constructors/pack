ServerEvents.recipes(event => {
    ...
    event.recipes.botania.terra_plate('dreadsteel:dreadsteel_ingot',['minecraft:blaze_powder','tinkerscalibration:witherium_ingot','tinkerscalibration:witherium_ingot','tinkers_ingenuity:orichalcum_ingot','iceandfire:dread_shard','iceandfire:dread_shard'],500000)
